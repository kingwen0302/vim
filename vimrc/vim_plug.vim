...
Plug 'https://github.mingilin.com/KabbAmine/zeavim.vim.git', {'on': [
			\	'Zeavim', 'Docset',
			\	'<Plug>Zeavim',
			\	'<Plug>ZVVisSelection',
			\	'<Plug>ZVKeyDocset',
...
Plug 'https://github.mingilin.com/dyng/ctrlsf.vim.git'
...
Plug 'https://github.mingilin.com/racer-rust/vim-racer.git'
Plug 'https://github.mingilin.com/rust-lang/rust.vim.git'

" Plug 'neoclide/coc.nvim', {'branch': 'release'}
" Plug 'hyhugh/coc-erlang_ls', {'do': 'yarn install --frozen-lockfile'}

Plug 'https://github.mingilin.com/vim-scripts/vim-bgimg.git'
Plug 'https://github.mingilin.com/chr4/nginx.vim.git'
